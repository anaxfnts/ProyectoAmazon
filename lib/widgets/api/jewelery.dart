...
// Widget que consulta a la api los resultado de la categoria Joyería y la muestra en cards
class JeweleryCard extends StatefulWidget {
  const JeweleryCard({super.key}); // Constructor del widget

  @override
  State<JeweleryCard> createState() => _MyWidgetState(); // Método para crear el estado del widget
}
...
class _MyWidgetState extends State<JeweleryCard> {
  ...
  // Consultamos a la api los resultado de la catgoria Joyería y lo almacenamos en una lista que devolvemos llena
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: AppBar(
          title: const Text('Joyería', style: TextStyle(color: Colors.white)),
          centerTitle: true,
